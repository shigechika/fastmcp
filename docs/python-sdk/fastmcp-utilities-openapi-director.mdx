...
### `RequestDirector` <sup><a href="https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/director.py#L27" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `build` <sup><a href="https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/director.py#L34" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
